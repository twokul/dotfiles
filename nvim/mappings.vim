...
" Plugins
source ~/.dotfiles/nvim/mappings/nerdtree.vim
source ~/.dotfiles/nvim/mappings/fzf.vim
source ~/.dotfiles/nvim/mappings/fugitive.vim
source ~/.dotfiles/nvim/mappings/airline.vim
